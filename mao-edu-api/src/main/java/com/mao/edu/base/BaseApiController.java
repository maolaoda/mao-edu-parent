package com.mao.edu.base;

import com.mao.edu.constant.ApiConstants;

/**
 * @author chenyao
 * @date 2023-10-18 09:25
 */
public class BaseApiController<T>
{
    ...
    public BaseResponse<T> setResultSuccessMsg(T msg) {
        return setResult(ApiConstants.HTTP_RES_CODE_200.getCode(), ApiConstants.HTTP_RES_CODE_200.getValue(), msg);
    }
    /**
     * 通用封装 通用封装
     *
